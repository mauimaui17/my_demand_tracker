# Generated by Django 4.2.10 on 2024-03-04 14:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ManyToManyField(blank=True, related_name='department_subs', to='tracker.department')),
                ('prereqs', models.ManyToManyField(blank=True, to='tracker.course')),
                ('sem_offered', models.ManyToManyField(blank=True, related_name='semester_subs', to='tracker.semester')),
                ('subject_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tracker.subject')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('shopping_cart', models.ManyToManyField(blank=True, related_name='students', to='tracker.course')),
